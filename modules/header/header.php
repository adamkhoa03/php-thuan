    <header class="wow fadeInDown affix-top" data-offset-top="197" data-spy="affix" style="visibility: visible;">
        <div class="logo-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <!-- Logo -->
                    <div class="col-sm-12 col-md-3 hidden-xs"> <a href="/php-thuan/index.php"><img src="images/logo.png" alt="Recruite Pro"></a> </div>
                    <!-- Navigation -->
                    <div class="col-sm-12 col-md-9">
                        <nav class="navbar navbar-default pull-right">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="/php-thuan/index.php"><img src="images/logo.png" alt="Recruite Pro"></a>
                            </div>
                            <!-- Collect the nav links, forms, and other content for toggling -->
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="/php-thuan/index.php">Home</a></li>
                                    ...
                                    <li class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">CÔNG VIỆC</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="/php-thuan/index.php?page=listjob">Danh sách công việc</a></li>
