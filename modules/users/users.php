        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2 col-xs-offset-0">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Tên" required="" type="text" name="hoten" value="<?= $user['hoten'] ?? '' ?>">
                            <input class="form-control" placeholder="Ngày Sinh" required="" type="date" name="ngaysinh" value="<?= $user['ngaysinh'] ?? '' ?>">
                            <input class="form-control" placeholder="Số điện thoại" required="" type="text" name="sodienthoai" value="<?= $user['sodienthoai'] ?? '' ?>">
                            <input class="form-control" placeholder="Địa chỉ" required="" type="text" name="diachi" value="<?= $user['diachi'] ?? '' ?>">
                            <input class="form-control" placeholder="Trường Học" required="" type="text" name="chuyennganh" value="<?= $user['chuyennganh'] ?? '' ?>">
                            <input class="form-control" placeholder="Giới tính" required="" type="text" name="gioitinh" value="<?= $user['gioitinh'] ?? '' ?>">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <?php
                            if (isset($user['anhdaidien']) && $user['anhdaidien'] != null) {
                            ...
                            <span class="btn btn-file form-control">Chứng Chỉ (Ảnh hoặc PDF):
                                <input type="file" accept=".pdf" name="chungchi" value="<?= $user['chungchi'] ?? '' ?>">
                            </span>
                            <span class="btn btn-file form-control">CV (PDF)::
                                <input type="file" name="hoso" accept=".pdf">
                            </span>
                            <textarea class="form-control" id="editor" placeholder="Thêm về bạn..." name="thongtinthem"><?= $user['thongtinthem'] ?? '' ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
